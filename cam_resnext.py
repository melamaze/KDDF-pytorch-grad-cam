...
if __name__ == '__main__':
    ...
    # Read global model
    global_model = ResNeXt29_2x64d()
    PATH = './model/resnext_15_0.2_V1_start.pth'
    global_model.eval().cuda()
    global_model.load_state_dict(torch.load(PATH))
    # Read examine model
    model = ResNet18()
    PATH = './student_model/student_resnext_15_0.2_V1_start.pth'
    model.eval().cuda()
    ...
    target_label = 7
    # target layer
    target_layers = [global_model.layer3]
